		...
		<div class="sidebar-menu">
			<ul id="accordion-menu">
				<li class="nav-link active" data-toggle="active">
					<a href="/adminDash" class="dropdown-toggle no-arrow">
				...
				<li class="dropdown">
					...
					<ul class="submenu">
						<li><a href="video-player.html">Laporan Barang Masuk</a></li>
						<li><a href="login.html">Laoran Barang Dipinjam</a></li>
						<li><a href="forgot-password.html">Laporan Barang Dikembalikan</a></li>
						<li><a href="reset-password.html">Laporan Barang Rusak</a></li>
					</ul>
				</li>
